...
namespace Joomla\Module\KsTagsPopular\Site\Helper;
 ...
 * @since  3.1
 */
class KsTagsPopularHelper implements DatabaseAwareInterface
{
        ...
        $query = $db->getQuery(true)
            ->select(
                [
                    ...
                    'MAX(' . $db->quoteName('t.images') . ') AS ' . $db->quoteName('images'),
            ...
            ->group($db->quoteName(['tag_id', 't.title', 't.images', 't.access', 't.alias']))
